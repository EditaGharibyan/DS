...
namespace HashMap
{
    public class MyDictionary<TK, TV> where TK : IComparable
    {
        private class Node
        {
        ...
        public TV this[TK key]
        {
            set
            {
                if (key == null || !MyContainsKey(key)) return ;
            ...
            get
            {
                if (key == null || !MyContainsKey(key)) return default(TV);
